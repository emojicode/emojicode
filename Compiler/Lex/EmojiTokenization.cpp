...
bool isEmoji(char32_t ch) {
    ...
    (0x265F <= ch && ch <= 0x2660) || ch == 0x2663 || (0x2665 <= ch && ch <= 0x2666) ||
    ch == 0x2668 || ch == 0x267B || (0x267E <= ch && ch <= 0x267F) ||
    ...
    (0x1F6F7 <= ch && ch <= 0x1F6F8) || ch == 0x1F6F9 || (0x1F910 <= ch && ch <= 0x1F918) ||
    (0x1F919 <= ch && ch <= 0x1F91E) || ch == 0x1F91F || (0x1F920 <= ch && ch <= 0x1F927) ||
    (0x1F928 <= ch && ch <= 0x1F92F) || ch == 0x1F930 || (0x1F931 <= ch && ch <= 0x1F932) ||
    (0x1F933 <= ch && ch <= 0x1F93A) || (0x1F93C <= ch && ch <= 0x1F93E) || (0x1F940 <= ch && ch <= 0x1F945) ||
    (0x1F947 <= ch && ch <= 0x1F94B) || ch == 0x1F94C || (0x1F94D <= ch && ch <= 0x1F94F) ||
    (0x1F950 <= ch && ch <= 0x1F95E) || (0x1F95F <= ch && ch <= 0x1F96B) || (0x1F96C <= ch && ch <= 0x1F970) ||
    (0x1F973 <= ch && ch <= 0x1F976) || ch == 0x1F97A || (0x1F97C <= ch && ch <= 0x1F97F) ||
    (0x1F980 <= ch && ch <= 0x1F984) || (0x1F985 <= ch && ch <= 0x1F991) || (0x1F992 <= ch && ch <= 0x1F997) ||
    (0x1F998 <= ch && ch <= 0x1F9A2) || (0x1F9B0 <= ch && ch <= 0x1F9B9) || ch == 0x1F9C0 ||
    (0x1F9C1 <= ch && ch <= 0x1F9C2) || (0x1F9D0 <= ch && ch <= 0x1F9E6) || (0x1F9E7 <= ch && ch <= 0x1F9FF);
}
...
bool isEmojiModifierBase(char32_t ch) {
    ...
    (0x1F93D <= ch && ch <= 0x1F93E) || (0x1F9B5 <= ch && ch <= 0x1F9B6) || (0x1F9B8 <= ch && ch <= 0x1F9B9) ||
    (0x1F9D1 <= ch && ch <= 0x1F9DD);
}
