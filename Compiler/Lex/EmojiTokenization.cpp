...
bool isEmoji(char32_t ch) {
    return ch == 0x00A9 || ch == 0x00AE || ch == 0x203C ||
           ...
           (0x1F6F7 <= ch && ch <= 0x1F6F8) || (0x1F910 <= ch && ch <= 0x1F918) || (0x1F919 <= ch && ch <= 0x1F91E) ||
           ch == 0x1F91F || (0x1F920 <= ch && ch <= 0x1F927) || (0x1F928 <= ch && ch <= 0x1F92F) ||
           ch == 0x1F930 || (0x1F931 <= ch && ch <= 0x1F932) || (0x1F933 <= ch && ch <= 0x1F93A) ||
           (0x1F93C <= ch && ch <= 0x1F93E) || (0x1F940 <= ch && ch <= 0x1F945) || (0x1F947 <= ch && ch <= 0x1F94B) ||
           ch == 0x1F94C || (0x1F950 <= ch && ch <= 0x1F95E) || (0x1F95F <= ch && ch <= 0x1F96B) ||
           (0x1F980 <= ch && ch <= 0x1F984) || (0x1F985 <= ch && ch <= 0x1F991) || (0x1F992 <= ch && ch <= 0x1F997) ||
           ch == 0x1F9C0 || (0x1F9D0 <= ch && ch <= 0x1F9E6);
}
...
bool isEmojiModifierBase(char32_t ch) {
    return ch == 0x261D || ch == 0x26F9 || (0x270A <= ch && ch <= 0x270B) ||
           ...
           ch == 0x1F91E || ch == 0x1F91F || ch == 0x1F926 ||
           ch == 0x1F930 || (0x1F931 <= ch && ch <= 0x1F932) || (0x1F933 <= ch && ch <= 0x1F939) ||
           (0x1F93D <= ch && ch <= 0x1F93E) || (0x1F9D1 <= ch && ch <= 0x1F9DD);
}
